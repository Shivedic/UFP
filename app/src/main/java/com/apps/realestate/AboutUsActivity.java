...
public class AboutUsActivity extends AppCompatActivity {
    ...
    private void setResult() {
        ...
        String text = "<html><head>"
                + "<style type=\"text/css\">@font-face {font-family: MyFont;src: url(\"file:///android_asset/fonts/custom.ttf\")}body{font-family: MyFont;color: #8b8b8b;text-align:justify;line-height:1.6}"
                + "</style></head>"
                + "<body>"
                + htmlText
                + "</body></html>";
